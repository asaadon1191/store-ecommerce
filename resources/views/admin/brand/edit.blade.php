                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('update.brands',$brand->id) }}"
                                          method="post"
                                        ...
                                        <div class="text-center">
                                            <img src="{{ asset('assets/admin/images/'. $brand->photo) }}" alt="" style="height: 100px; width:100px">
                                        </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> Brand Photo </label>
